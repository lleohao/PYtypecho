...
;(function (l, o, i, e) {
    ...
    i.extend(q, {
                ...
                if (i.type(y) === "object") {
                    ...
                    if (j(y)) {
                        w = {
                            ...
                            title: i("<div/>").text(y.data("fancybox-title") || y.attr("title") || "").html(),
                            isDom: true,
                            element: y
                        };
                        if (i.metadata) {
        ...
        update: function (t) {
            var r = (t && t.originalEvent && t.originalEvent.type), s = !r || r === "orientationchange";
            if (s) {
                clearTimeout(c);
                c = null
            }
        ...
        _afterLoad: function () {
            ...
            switch (y) {
                ...
                case"html":
                    ...
                    break;
                case"image":
                    x = w.tpl.image.replace(/\{href\}/g, r);
                    break;
                case"swf":
    ...
    q.transitions = {
        getOrigPosition: function () {
            ...
            if (t === "none") {
                ...
                q.wrap.css(s).animate(r, {duration: w.nextSpeed, easing: w.nextEasing, complete: q._afterZoomIn})
            }
        }, changeOut: function () {
            ...
            t.wrap.animate(r, {
                duration: s === "none" ? 0 : t.prevSpeed, easing: t.prevEasing, complete: function () {
    ...
    q.helpers.overlay = {
        defaults: {closeClick: true, speedOut: 200, showEarly: true, css: {}, locked: !f, fixed: true},
        overlay: null,
        fixed: false,
        el: i("html"),
        create: function (s) {
        ...
        beforeShow: function (r, s) {
            if (s.locked && !this.el.hasClass("fancybox-lock")) {
